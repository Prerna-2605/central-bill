...
const PrevArrow = ({ onClick }) => (
    <button
        onClick={onClick}
        className="z-5 group absolute min-[1232px]:left-[-55px] min-[1232px]:top-1/2 -translate-y-1/2 w-[40px] h-[40px] rounded-full border border-[#000] flex items-center justify-center cursor-pointer bg-white max-[769px]:hidden active:bg-black max-[1232px]:bottom-[-35%] max-[1232px]:right-[5.5%] max-[921px]:right-[7%] hover:shadow-lg transition-all duration-200 ">
...
const NextArrow = ({ onClick }) => (
    <button
        onClick={onClick}
        className="z-5 group absolute min-[1232px]:right-[-55px] min-[1232px]:top-1/2 -translate-y-1/2 w-[40px] h-[40px] rounded-full border border-[#000] flex items-center justify-center cursor-pointer bg-white max-[769px]:hidden active:bg-black max-[1232px]:bottom-[-35%] max-[1232px]:right-[1%] hover:shadow-lg transition-all duration-200 ">
        ...
        <div className="testimonial max-w-[1140px] px-3 mx-auto mb-[162px] ">
            <Slider {...settings}>
                {testimonial.map((content, index) => (
                    <div key={index} className='p-5 border border-[#E6E6E6] rounded-sm flex flex-col shadow-md '>
