    ...
    <div className='bg-[url(src/assets/png/Footer.png)] bg-cover bg-center bg-no-repeat'>
      <div className="max-w-[1140px] mx-auto px-3 pt-[68px] flex justify-between mb-[56.55px] max-[670px]:flex-col gap-10">
        ...
        <div className='flex min-[670px]:gap-[78px] justify-between'>
          <ul>
            <li className='font-bold text-[20px] leading-[1.5] text-white mb-3 max-md:text-[18px] '>
              Quick Link
            </li>
      ...
      <div className='w-full py-5 border-t border-[#34607E] flex justify-center'>
        <a href="" className='font-normal text-[14px] leading-[1.5] text-[#E5EBEF]'>
          © 2024 BILL CENTRAL, Inc. All Rights Reserved.
        </a>
      </div>
    </div>
  )
